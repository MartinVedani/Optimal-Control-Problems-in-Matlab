function [EndpointCost, RunningCost] = Brac11Cost(primal)
% Cost file file for "Brac1" with a path constraint.
%   References: 
...
%**************************************************************************
% Although this file is identical to the file Brac11Cost, it usually not a
